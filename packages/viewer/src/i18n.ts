...
const en = {
  ...
  legendTask: 'task', legendDoc: 'reference', legendFile: 'file (not parsed)', legendGhost: 'missing', legendSubagent: 'subagent call (isolated)',
...
const ko: Dict = {
  ...
  legendTask: '작업', legendDoc: '자료', legendFile: '파일 (파싱 안 함)', legendGhost: '없음', legendSubagent: '보조 작업 호출(서브에이전트)',
  send: '보냄', receive: '받음',
